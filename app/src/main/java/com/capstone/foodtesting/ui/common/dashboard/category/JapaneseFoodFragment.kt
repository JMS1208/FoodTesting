...
class JapaneseFoodFragment : Fragment() {
    ...
    private fun setupSwipeRefreshLayoutListener() {
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            viewModel.setupCategoryRestaurantListFromChildFragment("jf", latitude, longitude)
    ...
    private fun initCategoryRecyclerView() {
        ...
        viewModel.japaneseFoodRestaurantListLiveData.observe(viewLifecycleOwner) { restaurantList->
            restaurantList?.let {
