...
class DessertFragment : Fragment() {
    ...
    private fun setupSwipeRefreshLayoutListener() {
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            viewModel.setupCategoryRestaurantListFromChildFragment("de", latitude, longitude)
    ...
    private fun initCategoryRecyclerView() {
        ...
        viewModel.dessertRestaurantListLiveData.observe(viewLifecycleOwner) { restaurantList->
            restaurantList?.let {
