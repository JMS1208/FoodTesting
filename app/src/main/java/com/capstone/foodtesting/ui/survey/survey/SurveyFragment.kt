...
import com.capstone.foodtesting.databinding.FragmentSurveyBinding
import com.capstone.foodtesting.ui.survey.*
import com.capstone.foodtesting.ui.survey.add.QueryAddFragment
import com.capstone.foodtesting.ui.survey.completed.QueryCompletedFragment
import com.capstone.foodtesting.ui.survey.menu.QueryAboutMenuFragment
import com.capstone.foodtesting.ui.survey.overview.OverviewFragment
import com.capstone.foodtesting.ui.survey.restaurant.QueryAboutRestaurantFragment
...
class SurveyFragment : Fragment() {
    ...
    private val fragmentList = arrayOf(
        OverviewFragment(),
        QueryAboutRestaurantFragment(),
        QueryAboutMenuFragment(),
        QueryAddFragment(),
        QueryCompletedFragment()
    )
...
//                        })
        ...
        when (queryLine.queryType) {
            ...
            QueryLine.QueryType.type_add -> {
                ...
                if (binding.viewPager2.currentItem != 3) {
                    ...
                    val addFragment = fragmentList[3] as QueryAddFragment
    ...
    fun addQueryLine(query: String, keywordList: List<String>, queryType: QueryLine.QueryType): Int {
        val queryLine = QueryLine(query, keywordList, queryType)
