...
import com.capstone.foodtesting.databinding.FragmentQueryAddBinding
...
@AndroidEntryPoint
class QueryAddFragment : Fragment() {

    private var _binding: FragmentQueryAddBinding? = null
...
//    private val currentKeywords = mutableListOf<String>()
    ...
    private val viewModel by viewModels<QueryAddViewModel>()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentQueryAddBinding.inflate(inflater, container, false)
...
//            layoutManager = StaggeredGridLayoutManager(3, LinearLayoutManager.VERTICAL)
    ...
    private fun addQueryLine(query: String, keywordList: List<String>) {
        val result = (parentFragment as SurveyFragment).addQueryLine(query, keywordList,
    ...
    fun modifyQueryLine(queryLine: QueryLine) {
        ...
        viewModel.replaceKeywords(queryLine.keywords.toMutableList())
