package com.capstone.foodtesting.ui.restaurant.questionnaire.survey
...
import com.capstone.foodtesting.ui.restaurant.questionnaire.*
...
//                        })
        ...
        when (queryLine.queryType) {
            ...
            QueryLine.QueryType.TypeAdd -> {
                ...
                if (binding.viewPager2.currentItem != 3) {
                    ...
                    val addFragment = fragmentList[3] as RestaurantQueryRegisterAddPersonallyFragment
    ...
    fun addQueryLine(query: String, keywordList: List<String>, queryType: Int): Int {
        val queryLine = QueryLine(query = query, keywords = keywordList, queryType = queryType)
    ...
    fun createBalloon(text: String, view: View = binding.tvRight) {
        val balloon = Balloon.Builder(requireContext())
            ...
            .setHeight(BalloonSizeSpec.WRAP)
            .setText(text)
            .setTextColorResource(R.color.grey)
            .setTextSize(20f)
            .setArrowPositionRules(ArrowPositionRules.ALIGN_ANCHOR)
            .setArrowSize(10)
            .setArrowPosition(0.5f)
