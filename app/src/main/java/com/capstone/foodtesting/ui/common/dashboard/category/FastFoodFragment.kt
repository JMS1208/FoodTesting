...
class FastFoodFragment : Fragment() {
    ...
    private fun setupSwipeRefreshLayoutListener() {
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            viewModel.setupCategoryRestaurantListFromChildFragment("ff", latitude, longitude)
    ...
    private fun initCategoryRecyclerView() {
        ...
        viewModel.fastFoodRestaurantListLiveData.observe(viewLifecycleOwner) { restaurantList->
            restaurantList?.let {
