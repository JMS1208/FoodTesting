...
class ChineseFoodFragment : Fragment() {
    ...
    private fun setupSwipeRefreshLayoutListener() {
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            viewModel.setupCategoryRestaurantListFromChildFragment("cf", latitude, longitude)
    ...
    private fun initCategoryRecyclerView() {
        ...
        viewModel.chineseRestaurantListLiveData.observe(viewLifecycleOwner) { restaurantList->
            restaurantList?.let {
